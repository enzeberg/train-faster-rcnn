...
def parse_opt():
    ...
    parser.add_argument(
        '--show-image', dest='show_image', action='store_true',
        help='visualize output only if this argument is passed'
    )
    parser.add_argument(
        '--mpl-show', dest='mpl_show', action='store_true',
...
def main(args):
    ...
    if args['weights'] is not None:
        ...
        #     build_model = build_model[str(args['model'])]
        # except:
        #     build_model = build_model[checkpoint['model_name']]
